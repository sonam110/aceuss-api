...
Route::prefix('v1')->namespace('Api\V1')->group(function () {
	...
	Route::middleware('auth:api', 'isActiveToken','isAuthorized')->group(function () {
		...
		Route::post('revoke-patient-employee', [App\Http\Controllers\Api\V1\User\UserController::class, 'revokePatientEmployee']);
	   	...
	   	Route::get('get-company-active-package', [App\Http\Controllers\Api\V1\User\UserController::class, 'getCompanyActivePackage']);
		...
		Route::post('print-deviation','User\DeviationController@printDeviation');
