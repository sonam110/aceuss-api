...
class CreateActivitiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('activities', function (Blueprint $table) {
            ...
            $table->timestamp('notify_before_time')->nullable();
            ...
            $table->timestamp('notify_after_time')->nullable();
            ...
            $table->timestamp('notify_emergency_time')->nullable();
            ...
            $table->timestamp('notify_in_time')->nullable();
