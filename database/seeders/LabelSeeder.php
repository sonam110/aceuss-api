    ...
    public function run()
    {
    	...
    	$groupLabels = [
    		...
    		"Deviation" => [
                ...
                "message_signed_deviation_cannot_be_updated" => "Signed deviation cannot be updated",  
    			"message_id" => "Id is required",  
    			'message_category_id' => 'Category id field is required',   
    		...
    		'mobile_web' => [
                ...
                "short-term-activity"=> "Short Term Activity",
                ...
                "company-to-patient"=> "File for Patient",
                ...
                "contactPerson-dashboard"=> "Contact Person Dashboard",
                "familyMember-dashboard"=> "Family Member Dashboard",
                "guardian-dashboard"=> "Guardian Dashboard",
                "other-dashboard"=> "Other Dashboard",
                "change-series-date"=> "Change Series Date",
                "repetition-comment"=> "Repetition Comment",
                ...
                "patient-dashboard"=> "Patient Dashboard",
                "caretaker-dashboard"=> "CareTaker Dashboard",
                "contactPerson-dashboard"=> "ContactPerson Dashboard",
                "familyMember-dashboard"=> "FamilyMember Dashboard",
                "guardian-dashboard"=> "Guardian Dashboard",
                "other-dashboard"=> "Other Dashboard",
                "change-series-date"=> "Change Series Date",
                "repetition-comment"=> "Repetition Comment",
                ...
                "bank-id-usage"=> "Bank Id Usage",
                "sms-usage"=> "SMS Usage",
                "ip-plans"=> "Implementations",
                "do-you-really-want-to-sign-this-journal?"=> "Do You Really Want to Sign This Journal?",
                "jan"=> "Jan",
                "feb"=> "Febr",
                "mar"=> "Mars",
                "apr"=> "April",
                ...
                "work-percentage"=> "Work Percentage",
                "at"=> "Signed at",
                "reply-comment"=> "Reply Comment",
                "approval-modal"=> "Approval Modal",
                "rejection-modal"=> "Rejection Modal",
                "approve-leave-&-assign-employee"=> "Approve Leave & Assign Employee",
                "approve-by"=> "Approve By",
                "leave-not-approved"=> "Leave Not Approved",
                "edit-question"=> "Edit Question",
                "follow-up-reminder"=> "Followup Reminder",
                "edit-schedule-template"=> "Edit Schedule Template",
                "settings"=> "Settings",
                ...
                "leave-approval-date"=> "Leave Approval Date",
                 "personal-number-field-information"=>"The personal identity number following your date of birth in the format=> YYYYMMDD-XXXX",
                "msg_repeat_not_avail_for_date"=>"repeat is not available for this date range",
                "leave-request-info"=>"Leave Request info",
                "email_associated_with_another_account"=>"this email is already associated with another account",
                "value_should_be_below"=> "value should be below",
                "change-email"=> "Change email",
                "notify-to-employee"=> "Notify To Employee",
                "employee-detail"=> "Employee detail",
                "schedule-detail"=> "Schedule detail",
                "approve/incomplete"=> "Approve/Incomplete",
                "by-manual"=> "By Manual",
                "by-mobile-bank-id"=> "By Mobile Bank Id",
                "create-licence-key"=> "Create-Licence-Key",
                "assign-this-licence"=> "Assign This Licence",
                "licence-assigned"=> "Licence Assigned Successfully",
                "mobile"=> "Mobile",
                ...
                "secret"=> "Secret",
                "total-hour-per-week"=> "Total hours per week",
                "work-grade(%)"=> "Work Grade(in %)",
                "create-receipt-no"=> "Create Reciept No.",
                "shift-end-date"=> "Shift End Date",
                "schedule-filter"=> "Schedule Filter",
                "select-date-range"=> "Select Date Range",
                "leave-filter"=> "Leave Filter",
                "apply-this-leave-for-vacation-trip"=> "Apply This Leave for Vacation Trip",
                "assign-work-to-single-employee"=> "Assign Work to Single Employee",
                "expire-this-licence"=> "Expire This Licence",
                "reason-for-expiry"=> "Reason for Expiry",
                "from-amount"=> "From Amount",
                "to-amount"=> "To Amount",
                "parent-company-name"=> "Parent Company Name",
                "parent-company-email"=> "Parent Company Email",
                "parent-company-contact-no"=> "Parent Company Contact No.",
                "assigned-branch"=> "Assigned Branch",
                "assigned-patient"=> "Assigned Patient",
                "happy-birthday"=> "Happy Birthday",
                "have-a-great-future-ahead"=> "Have a Great Future Ahead...",
                "please-accept-following-terms-condition"=> "Please Accept Following Terms Condition",
                "no-journals-found"=> "No Journals Found",
                "set-new-password"=> "Set New Password",
                "your-licence-had-expired"=> "Your Licence Had Expired",
                "to-renew-your-licence-please-fill-the-details-below"=> "To Renew Your Licence Please Fill the Details Below",
                "please-enter-valid-license"=> "Please Enter Valid License",
                "all-rights-reserved"=> "All Rights Reserved",
                "hand-crafted-made-with"=> "Hand Crafted Made With",
                "employee"=> "Employee",
                "is-fake-email"=> "Is fake Email",
                ...
                "i-want-to-report-a-value-damage"=> "I want to report a value damage",
                "i-want-to-report-a-wild-damage"=> "I-want to report a wild damage",
                "enter-personal-details"=> "Enter Personal Details",
                "emergency"=> "Emergency",
                "on-vacation"=> "On Vacation",
                "ob-red-start-time"=> "Ob Red Start Time",
                "ob-red-end-time"=> "Ob Red End Time",
                "ob-red-hours"=> "Ob Red Hours",
                "ob-weekday-start-time"=> "Ob Weekday Start Time",
                "ob-weekday-end-time"=> "Ob Weekday End Time",
                "ob-weekday-hours"=> "Ob Weekday Hours",
                "ob-weekend-start-time"=> "Ob Weekend Start Time",
                "ob-weekend-end-time"=> "Ob Weekend End Time",
                "ob-weekend-hours"=> "Ob Weekend Hours",
                ...
                "notify"=> "Notify",
                "we-re-creating-something-awesome-please-subscribe-to-get-notified-when-it-s-ready"=> "We're creating something awesome. Please subscribe to get notified when it's ready!",
