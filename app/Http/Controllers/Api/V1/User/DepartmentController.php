...
class DepartmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
		    ...
		    [
            'name.required' =>  getLangByLabelGroups('Department','message_name'),
            ]);
        	...
        	if($checkAlready) {
              	return prepareResult(false, getLangByLabelGroups('Department','message_name_already_exists'),[], config('httpcodes.bad_request')); 
        	}
    ...
    public function update(Request $request,$id){
        ...
        try {
            ...
            $department->entry_mode = (!empty($request->entry_mode)) ? $request->entry_mode :'Web';
		 	$department->save();
              DB::commit();
	        return prepareResult(true,getLangByLabelGroups('Department','message_update'),$department, config('httpcodes.success'));
    ...
    public function destroy($id){
        ...
        try {
        	...
        	$department = Department::where('id',$id)->delete();
         	return prepareResult(true,getLangByLabelGroups('Department','message_delete'),[], config('httpcodes.success'));
