...
class QuestionController extends Controller
{
    ...
    public function questions(Request $request)
    {
     ...
     public function store(Request $request){
        try {
            ...
            $question->save();
             return prepareResult(true,getLangByLabelGroups('CompanyType','create') ,$question, '200');
        }
        catch(Exception $exception) {
            return prepareResult(false, $exception->getMessage(),[], '500');
    ...
    public function show($id){
        ...
        try {
            ...
            if (!is_object($checkId)) {
                return prepareResult(false, getLangByLabelGroups('CompanyType','id_not_found'), [],'404');
            }
    ...
    public function update(Request $request,$id){
        try {
            ...
            $question->entry_mode = (!empty($request->entry_mode)) ? $request->entry_mode :'Web';
            $question->save();
            return prepareResult(true,getLangByLabelGroups('CompanyType','update'),$question, '200');
    ...
    public function destroy($id){
        ...
        try {
            ...
            return prepareResult(true, getLangByLabelGroups('CompanyType','delete') ,[], '200');
