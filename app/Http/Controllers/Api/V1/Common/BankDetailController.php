...
class BankDetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
		    ...
		    [
            'bank_name.required' => getLangByLabelGroups('Bank','message_bank_name'),
            'account_number.required' => getLangByLabelGroups('Bank','message_account_number'),
            'clearance_number.required' => getLangByLabelGroups('Bank','message_clearance_number'),
            ]);
	        if ($validator->fails()) {
        	...
        	if($checkAlready) {
              	return prepareResult(false, getLangByLabelGroups('Bank','message_name_already_exists'),[], config('httpcodes.bad_request')); 
        	}
    ...
    public function update(Request $request,$id)
    {
        ...
        try {
        	...
        	if($checkAlready) {
              	return prepareResult(false, getLangByLabelGroups('Bank','message_ name_already_exists'),[], config('httpcodes.bad_request')); 
        	}
	        ...
	        return prepareResult(true, getLangByLabelGroups('Bank','message_update') ,$bankDetail, config('httpcodes.success'));
