...
class SalaryController extends Controller
{
    public function updateSalaryDetail(Request $request)
    {
        ...
        try {
            ...
            [
            'user_id.required' => getLangByLabelGroups('Salary','message_user_id'),
            'salary_per_month.emrequiredail' => getLangByLabelGroups('Salary','message_salary_per_month'),
            'salary_package_start_date.required' =>  getLangByLabelGroups('Salary','message_salary_package_start_date'),
            'salary_package_end_date.required' =>  getLangByLabelGroups('Salary','message_salary_package_end_date'),
            'salary_package_end_date.after' =>  getLangByLabelGroups('Salary','message_salary_package_end_date_after'),
            ]);
	        if ($validator->fails()) {
