...
class CompanyAccountController extends Controller
{
    ...
    public function companies(Request $request)
    {
        try {
            $user = getUser();
            $query = User::select('users.*')->where('status','1')->with('Parent:id,name','UserType:id,name','Country:id,name','Subscription:user_id,package_details','modules:id,user_id,module_id','modules.Module:id,name')->withcount('tasks','activities','ips','followUps','patients','employees','modules','branchs')->where('role_id','2') ;
    ...
    public function show(User $user)
    {
        try {
            ...
            $userShow = User::where('id',$user->id)->with('Parent:id,name','UserType:id,name','Country:id,name','Subscription:user_id,package_details','modules:id,user_id,module_id','modules.Module:id,name')->withcount('tasks','activities','ips','followUps','patients','employees','modules','branchs')->first();
