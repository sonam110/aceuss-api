...
class LanguageController extends Controller
{
    ...
    { 
    	...
    	try 
    	{
    		...
    		if($count>=1)
    		{
    			return prepareResult(false,getLangByLabelGroups('BcCommon','message_record_already_exists'), [],config('httpcodes.not_found'));
    ...
    {
    	return prepareResult(true,getLangByLabelGroups('BcCommon','message_show') ,$language, config('httpcodes.success'));
    }
    ...
    public function destroy(Language $language)
    {
    	try 
    	{
    		...
    		{
    			return prepareResult(false ,getLangByLabelGroups('BcCommon','message_english_cannot_be_deleted') ,['English language can not be deleted'], config('httpcodes.success'));
    		}
    		else
    		{  
