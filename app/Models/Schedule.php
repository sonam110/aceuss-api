...
class Schedule extends Model
{
    ...
    protected $fillable  = ['top_most_parent_id','user_id','patient_id','shift_id','parent_id','created_by','slot_assigned_to','employee_assigned_working_hour_id','schedule_template_id','schedule_type','group_id','shift_name','shift_date','shift_start_time','shift_end_time','shift_color','leave_applied','leave_applied_date','leave_group_id','leave_type','leave_reason','leave_approved','leave_approved_date_time','leave_notified_to','is_active','scheduled_work_duration','extra_work_duration','ob_work_duration','status','entry_mode','notified_group','leave_approved_by','ob_type','branch_id','emergency_work_duration','vacation_duration','ob_start_time','ob_end_time','shift_type','approved_by_company', 'company_sessionId','verified_by_employee','employee_sessionId', 'ob_red_end_time', 'ob_end_time', 'ob_weekend_start_time', 'ob_weekend_end_time', 'ob_weekday_start_time', 'ob_weekday_end_time'];
